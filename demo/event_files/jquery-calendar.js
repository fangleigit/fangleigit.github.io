...
var popUpCal = {
	...
	yearRange: '-5:+0', // Range of years to display in drop-down, either relative to current year (-nn:+nn) or absolute (nnnn:nnnn)
	...
	showCalendar: function() {
		...
		if (this.timeSeparators && this.timeSeparators.length > 1) {
			...
			timeSelect += '</select> ' + this.timeSeparators[1] + ' 00 <select id="calendar_minute" style=" display:none">';
			//原来的代码，上行为我修改后的
